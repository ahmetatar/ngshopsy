...
describe('Authentication Tests', () => {
  describe('token validations', () => {
    /**
     * Token validation tests, test the interoperability of the following application components;
     * - AuthStore
     *   - Effects
     *   - Reducers
  ...
  describe('user authorization', () => {
    /**
     * User authorization tests, test the interoperability of the following application components;
     * - Routing
     * - AuthGuard
     */
    beforeEach(() => {
